...
<head>
    ...
    <title>Family Account Credentials</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>Your family account has been created successfully. Below are your login credentials:</p>
        ...
        <p>You can login to the family portal using the link below:</p>
